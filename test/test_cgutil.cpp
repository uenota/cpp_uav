...
TEST(CGUtilTest, CalcDistanceTest)
{
    ...
    EXPECT_NEAR(0.5, calc_distance(edge, vertex), 1.0e-5);
    ...
    EXPECT_NEAR(1.0, calc_distance(edge, vertex), 1.0e-5);
    ...
    EXPECT_NEAR(0.596284794, calc_distance(edge, vertex), 1.0e-5);
    ...
    EXPECT_NEAR(0.3535533906, calc_distance(edge, vertex), 1.0e-5);
...
TEST(CGUtilTest, CalcVertexAngleTest)
{
    ...
    p3.x = 1.0;
    p3.y = 1.0;
    EXPECT_DOUBLE_EQ(M_PI_4, calc_vertex_angle(p1, p2, p3));
    ...
    p3.x = 0.0;
    p3.y = 1.0;
    EXPECT_DOUBLE_EQ(M_PI_2, calc_vertex_angle(p1, p2, p3));
    ...
    p3.x = -1.0;
    p3.y = 1.0;
    EXPECT_DOUBLE_EQ(3 * M_PI_4, calc_vertex_angle(p1, p2, p3));
    ...
    EXPECT_DOUBLE_EQ(2 * M_PI / 3.0, calc_vertex_angle(p1, p2, p3));
    ...
    p3.y = -0.5;
    EXPECT_DOUBLE_EQ(5 * M_PI / 6.0, calc_vertex_angle(p1, p2, p3));
...
TEST(CGUtilTest, CalcHorizontalAngleTest)
{
    ...
    p2.x = 1.0;
    p2.y = 0.0;
    EXPECT_DOUBLE_EQ(0, calc_horizontal_angle(p1, p2));
    ...
    p2.x = 1.0;
    p2.y = 1.0;
    EXPECT_DOUBLE_EQ(M_PI_4, calc_horizontal_angle(p1, p2));
    ...
    p2.x = -0.5;
    p2.y = std::sqrt(3) / 2.0;
    EXPECT_DOUBLE_EQ(2 * M_PI / 3, calc_horizontal_angle(p1, p2));
    ...
    p2.x = 0.0;
    p2.y = -1.0;
    EXPECT_DOUBLE_EQ(M_PI_2, calc_horizontal_angle(p1, p2));
...
TEST(CGUtilTest, CalcSignedAreaTriangleTest)
{
    ...
    p3.x = 0.0;
    p3.y = 1.0;
    EXPECT_DOUBLE_EQ(1.0, calc_signed_area_triangle(p1, p2, p3));
    ...
    p3.x = 2.0;
    p3.y = -1.0;
    EXPECT_DOUBLE_EQ(-5.0, calc_signed_area_triangle(p1, p2, p3));
